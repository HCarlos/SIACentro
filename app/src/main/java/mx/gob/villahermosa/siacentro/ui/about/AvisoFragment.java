...
import mx.gob.villahermosa.siacentro.databinding.FragmentAvisoBinding;
...
public class AvisoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mx.gob.villahermosa.siacentro.databinding.FragmentAvisoBinding binding = FragmentAvisoBinding.inflate(inflater, container, false);
        View root = binding.getRoot();
        activity = getActivity();

        webView = root.findViewById(R.id.wv_aviso_app);
...
//        webView.setWebViewClient(new WebViewClient());
        ...
        webView.loadUrl(AppConfig.URL_AVISO_PRIVACIDAD);
