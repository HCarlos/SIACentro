...
import mx.gob.villahermosa.siacentro.databinding.ActivityAddImageBinding;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class AddImageActivity extends AppCompatActivity implements Callback<ComboResponse> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mx.gob.villahermosa.siacentro.databinding.ActivityAddImageBinding binding = ActivityAddImageBinding.inflate(getLayoutInflater());
        ...
        txtTitulo.setText(String.format("Agregar Imagen al folio: %d", denuncia_id));
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        if (photoPath != null) {
                            ...
                            if(imgFile.exists()) {
                                ...
                                imageToSend.setImageBitmap(imagenBitMapASubir);
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        if (selectedPath != null) {
                            ...
                            try {
                                ...
                                btnSaveImagen.setEnabled(true);
                                IsIMage = true;
                                imageToSend.setImageBitmap(bmp);
                                btnRotateImagen.setVisibility(View.VISIBLE);
...
//                                    e.printStackTrace();
    ...
    public void savePhoto(){
        ...
        if (! image_user.equals("") ) {
            Call<ComboResponse> call = ApiDenunciaAdapter.getApiService().addImageDenunciaSend(
                    "Bearer " + autoriza,
                    image_user,
                    denuncia_id,
                    user_id
...
//        Log.d("FallaUsuario", "tamaño de usuario --->   " + t.getMessage());
    ...
    public void showImage(){
        int dr = R.drawable.ic_baseline_spa_24;
        Picasso
                .get()
                .load(dr)
